...
public class TestViewGraphicalController {
    private List<ToggleGroup> toggleList = new ArrayList<>();


    public Pane createTest(){
    ...
    public Pane createTestResult(BreedBean breedBean){
